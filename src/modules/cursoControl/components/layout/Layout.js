...
import ProfileMenu from "../../../expenseAudit/components/Profile/ProfileMenu";
...
const Layout = ({ children }) => {
  ...
  const navigation = [
    { name: "Control de Cursos", path: CURSO_CONTROL_ROUTES.CURSOS.LIST },
    { name: "Personas", path: CURSO_CONTROL_ROUTES.PERSONAS.LIST },
