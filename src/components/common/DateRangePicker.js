...
const DateRangePicker = ({
 ...
 return (
   <div className={cn("relative", className)} ref={containerRef}>
     <div
       className="relative bg-white flex items-center gap-2 w-full p-2 border rounded-lg cursor-pointer hover:bg-gray-50"
         ...
         <div className="flex items-center justify-between mb-4">
           ...
           <div className="flex items-center gap-2">
             <select
               ...
               onChange={(e) => setActiveMonth(new Date(activeYear, parseInt(e.target.value)))}
